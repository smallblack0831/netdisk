<template>
  <div class="container">
    ...
    <div style="display: flex; justify-content: center; width: 100%">
      <div style="width: 350px; padding: 50px 30px; box-shadow: 0 0 10px rgba(0,0,0,.2); background-color: #fff; border-radius: 15px;">
        <div style="text-align: center; font-size: 24px; font-weight: bold; margin-bottom: 30px; color: #333">欢 迎 注 册 网 盘 系 统</div>
        <el-form :model="form" :rules="rules" ref="formRef">
          ...
          <el-form-item>
            <el-button type="primary" round style="width: 100%; color: white" @click="register">注 册</el-button>
          </el-form-item>
