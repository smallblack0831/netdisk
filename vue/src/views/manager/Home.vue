<template>
  <div>
    ...
    <div style="display: flex; grid-gap: 10px; margin: 10px 0">
      ...
      <div style="width: 50%;" class="card">
        <div style="margin-bottom: 30px; font-size: 20px; font-weight: bold">消息通知</div>
        <div >
          <el-timeline  reverse slot="reference">
            <el-timeline-item type="primary" v-for="item in notices" :key="item.id" :timestamp="item.time">
              <el-popover
                  placement="right"
                  width="200"
                  trigger="hover"
